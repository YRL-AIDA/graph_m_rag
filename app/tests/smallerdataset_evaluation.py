...
if __name__ == '__main__':
    dataset = read_json('SmallerDataset_answers.json')
    nonecount = 0
    ...
    print(nonecount)
    show_results(dataset, show_path=re.sub(r"\.json$", ".txt", 'SmallerDataset_answers_evaluated.json'))
    with open('SmallerDataset_answers_evaluated.json', 'w') as f:
        json.dump(dataset, f)
