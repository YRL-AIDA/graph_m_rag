...
import base64
from src.emb_utils import EmbedResponse, Message, EmbedRequest
...
if __name__ == "__main__":
    ...
    messages = [
        Message(type="image", image_path="/home/user/RAG/Graph-M-RAG/mytests/test_image.jpg"),
    ]

    # Initialize the client (point to your actual service URL)
    client = EmbeddingClient(base_url="http://192.168.19.127:10115/embedding")

    try:
        result1 = client.get_image_embedding("/home/user/RAG/Graph-M-RAG/mytests/test_image.jpg")
        result2 = client.get_image_embedding_url("https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VL/assets/demo.jpeg")
        #result = client.get_embeddings(messages)
        #print(result1==result2)
        print(f"Message ID: {result1.message_id}")
        print(f"Embedding (first 5 values): {result1.embedding[:5]}...")
    except Exception as e:
        print(f"Error: {e}")
